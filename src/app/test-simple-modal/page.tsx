...
// Version ultra-simple du modal pour les tests
function SimpleModal({ visible, onClose }: { visible: boolean; onClose: () => void }) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Page de test SIMPLE pour le modal complet avec vidéo → quiz → scratch card
          </p>
        </div>
