...
const reductionsPoints = {
  id: "reductions-points",
                ...
                features: [
                  {
                    type: "Feature",
                    properties: {},
                    geometry: { type: "Point", coordinates: [-61.53, 16.27] },
                  },
                  {
                    type: "Feature",
                    properties: {},
                    geometry: { type: "Point", coordinates: [-61.52, 16.26] },
                  },
                ],
              }}
            >
              <Layer {...reductionsPoints} />
            </Source>
          )}

          {/* Polygones utilisateurs */}
          {zones.map((z, i) => (
